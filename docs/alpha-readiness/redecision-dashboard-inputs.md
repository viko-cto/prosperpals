...
- **Canonical interview tracker current:** partial — `docs/alpha-readiness/interview-evidence-tracker.md` exists, the slot design/screener is fixed in `docs/alpha-readiness/interview-cohort-plan-and-screener.md`, and recruiting/scheduling discipline is now fixed in `docs/alpha-readiness/interview-recruitment-and-scheduling-runbook.md`, but real participants, session logs, and threshold math are still unpopulated
